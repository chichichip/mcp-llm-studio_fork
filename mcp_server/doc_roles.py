...
⚠ 이 판정은 **경고를 붙이고 도구를 안내하는 용도**다. 판정이 틀려도 검색은 그대로
...
ROLE_NOTES = {
    "table": (
        "⚠ **치수표**입니다. 여기 보이는 숫자를 부품 선정 근거로 쓰지 마세요 — 청크 "
